 ...
 */
public class ImBatchPass extends BasePanel {
    ...
    String device = null;
    String repair = null;
    JTextField jt4 = new JTextField("1721-");
    PassService passService;

    JLabel jl3 = new JLabel("數據輸入");
    JLabel jl4 = new JLabel("Error Code");
    JLabel jl5 = new JLabel("");
    JLabel jl7 = new JLabel("顏色");
    JLabel jl8 = new JLabel("模具號");

    public ImBatchPass(UI_InitVO uiVO) {
        super(uiVO);
        this.uiVO = uiVO;
        ...
        jt1.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e1) {
                ...
                if (key == '\n') {
                    jt2.setText("");
                    mce = jt4.getText();
                    sne = jc1.getSelectedItem().toString();
                    if ("SP".equals(sne)){
                        sne = "B";
                    }else {
                        sne = "W";
