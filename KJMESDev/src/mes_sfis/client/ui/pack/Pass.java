 ...
 */
public class Pass extends BasePanel {
    ...
    JLabel jl7 = new JLabel("供應商");

    public Pass(UI_InitVO uiVO) {
        super(uiVO);
        this.uiVO = uiVO;
        ...
        try {
            ...
            scanner = a.iniHash.get("epega.exe.scanner").toString();
        } catch (Exception e) {
    ...
    public void init() {
        ...
        jc1.setBounds(540,190,100,30);
        jb5.setBounds(660,190,80,30);
        jl7.setBounds(540,160,100,30);
