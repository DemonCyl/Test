 ...
 * $Id: Barcode_1709_DCKey.java,v 1.2 2017/07/21 00:24:01 Jieyu_Fu Exp $
 */
...
/**
 * The <code>Barcode_1709_DCKey</code> class.
 *
 * @version     $Name:  $, $Id: Barcode_1709_DCKey.java,v 1.2 2017/07/21 00:24:01 Jieyu_Fu Exp $
 * @author      <a href="mailto:william_tsai@Pegatroncorp.com">William Tsai</a>
 * @history      [>: General, +: New, #: Modification, -: Remove, ~: Bug]
 *
 */
public class Barcode_1709_DCKey extends BasePanel{
	
	
    public static final String VERSION    = "$Name:  $, $Id: Barcode_1709_DCKey.java,v 1.2 2017/07/21 00:24:01 Jieyu_Fu Exp $";
    public static final String COPYRIGHT  = "Copyright (c) 2008 PEGATRON Inc. All Rights Reserved.";
	Barcode_1709_DCKey self;
	Font						f14;
	Font						f13;
	Font						f12;
	...
	JTextArea jta;
	String a3;
	public Barcode_1709_DCKey(UI_InitVO uiVO) {
		super(uiVO);
		init(); 
	}
	void init(){
	...
	private void doPrint(boolean isPrint,String printNum){
		...
		try{
			...
			for(int i=1;i<=num;i++){
				...
				img2.setAbsolutePosition(135,30);
				document.add(img2);
		...
		if(isPrint){
			...
			setMessage("資料已匯出到   d:/HuaWei.pdf ");
		}
	}
	...
	public void createPdfTable(PdfWriter writer,String mmo) {
		...
		try{
			...
			pdftable.addCell(createCell("Date Code1:" + a3,f14,0,0));
			pdftable.addCell(createCell("QTY:" + JTQty.getText().trim(),f14,0,0));
