...
public class LF_1709_maxprint extends BasePanel {
    public static final String VERSION    = "$Name:  $, $Id: LF_1709_maxprint.java,v 1.4 2017/09/14 07:54:59 Lucy6_Lu Exp $";
    public static final String COPYRIGHT  = "Copyright (c) 2008 PEGATRON Inc. All Rights Reserved.";
    private String year;
    private String month;
    private String week;
    private String day;
    LF_1709_maxprint self;
    ...
    //JDialog  toastDialog;
    public LF_1709_maxprint(UI_InitVO uiVO) {
        super(uiVO);
        init();
    }
    public void init(){
        ...
        JCStage.addItemListener(new ItemListener() {
            @Override
            public void itemStateChanged(ItemEvent e) {
                String man_pn = (String) JCStage.getSelectedItem();
                String[] mes = Item(man_pn);
        ...
        buttonMidPrint.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if( JCStage.getSelectedItem().equals("")||JTVenC.getText().toString().trim().equals("")){
        ...
        buttonsure.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                String man_pn = (String) JCStage.getSelectedItem();
                String imgPath = GetImgpath(man_pn);
                if(jtfprintnum.getText().toString().trim().equals("")){
                    JOptionPane.showConfirmDialog(null,"輸入不能為空","警告",JOptionPane.PLAIN_MESSAGE);
                }else{
                    String str1 = printMessage.getText().toString().trim();
                    String str2 = surplusnum.getText().toString().trim();
                    JTQty.setText(jtfprintnum.getText().toString().trim());
                    Printdo(true,imgPath,false);
        ...
        printbutton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                  if(JTQty.getText().trim().equals("")|| JTBt.getText().trim().equals("")){
                    ...
                    String man_pn = JTStage.getText().trim();
                    String imgPath = GetImgpath(man_pn);
    ...
    public String[] Item(String Man_PN){
        ...
        try {
            ...
            if(vct2.size()>1){
                ...
                String[] res = {customer_pn,vendor,manufactuer,country,rev,dec};
                result = res;
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void doPrint(boolean isPrint,String imgPath,Boolean reprint){
        ...
        try{
            ...
            document.add(pdftable);
            ZXingCode.getLogoQRCode("P" + JTVenC.getText().trim() + " 1P" + manPN + " Q" + JTQty.getText().trim() + " V" + JTlc.getText().trim()
            ...
            img.setAbsolutePosition(125,160);
            document.add(img);
